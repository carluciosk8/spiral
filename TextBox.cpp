...
void TextBox::Begin()
{
    ...
    glPushMatrix();
        glLoadIdentity();
        //glOrtho(0.0, 720.0, 480.0, 0.0, -1.0, 1.0);
        glOrtho(boxL, boxR, boxB, boxT, -1.0, 1.0);
...
//---------------------------------------------------------------------------
void TextBox::DrawStr(int x, int y, const char * str) {
    Begin();
    DrawStr(x, y, 0, 0, str);
    End();
}
...
//---------------------------------------------------------------------------
void TextBox::DrawStr(int x, int y, int maxFlag, int maxY, const char* string) {
    int cursorX;
    int cursorY;
...
unsigned int TextBox::fontID = 666666666;



const COLOR  TextBox::BLACK =   { 0 , 0 , 0 , 255 };
const COLOR  TextBox::GREY =    { 128 , 128 , 128 , 255 };
const COLOR  TextBox::GREEN =   { 0 , 0 , 0 , 255 };
const COLOR  TextBox::WHITE =   { 255 , 255 , 255 , 255 };
const COLOR  TextBox::YELLOW =  { 255 , 255 , 0 , 255 };
const COLOR  TextBox::BLUE =    { 0 , 0 , 0 , 255 };
const COLOR  TextBox::RED =     { 0 , 0 , 0 , 255 };
const COLOR  TextBox::MAGENTA = { 0 , 0 , 0 , 255 };
const COLOR  TextBox::CYAN =    { 0 , 0 , 0 , 255 };


//---------------------------------------------------------------------------
// The Texture Font data
//---------------------------------------------------------------------------
const unsigned char TextBox::fontData[64 * 128 * 2] =
{
